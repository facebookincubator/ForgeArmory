...
```bash
ttpforge run forgearmory//defense-evasion/signed-binary-proxy-regasm/ttp.yaml
```
```bash
ttpforge run forgearmory//defense-evasion/signed-binary-proxy-regasm/ttp.yaml --arg script\script.cs
```
