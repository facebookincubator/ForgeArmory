...
```bash
ttpforge run forgearmory//persistence/add-shortcut-startup/ttp.yaml
```
```bash
ttpforge run forgearmory//persistence/add-shortcut-startup/ttp.yaml --arg shortcut=shortcutTest
```
```bash
ttpforge run forgearmory//persistence/add-shortcut-startup/ttp.yaml --arg target=C:\Windows\System32\test.exe
```
