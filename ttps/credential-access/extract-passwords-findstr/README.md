...
```bash
ttpforge run forgearmory//credential-access/extract-passwords-findstr/ttp.yaml
```
```bash
ttpforge run forgearmory//credential-access/extract-passwords-findstr/ttp.yaml --arg password=true
```
