...
```bash
ttpforge run forgearmory//command-and-control/establish-tor-proxy/ttp.yaml
```
```bash
ttpforge run forgearmory//command-and-control/establish-tor-proxy/ttp.yaml --arg torExe=Tor\tor.exe
```
```bash
ttpforge run forgearmory//command-and-control/establish-tor-proxy/ttp.yaml --arg sleepTime=30
```
